...
for character in ocurrences:
    if character in paragraph:
        ...
        #ocurrences[character] = 1   esta forma tambien es correcta
        ocurrences.update({character : 1})
#Imprimir sin formato:
#print (ocurrences)    
#Imprimir con formato forma 1:
#for k in ocurrences:   
    #print(f"El caracter '{k}' aparece {ocurrences[k]} veces")

#imprimir con formato forma 2
for key, value in ocurrences.items():
    print(f"El caracter {key} aparece {value} veces")
#dic.items() -> retorna una lista de tuplas
#[('T', 1), ('w', 4)...]

#Imprimir con formato forma 3
for im_a_tuple in ocurrences.items():
    print(f"El caracter '{im_a_tuple[0]}' aparece {im_a_tuple[1]} veces")

#Destructuring tuples, partes la tupla y la asignas a nuevas variables
t = (1,2,3)
x,y,z = t

#Opción 2
ocurrences = {}
#print(ocurrences.get("a",0))  Recordar que el método get no inserta nuevos elementos, sólo consulta y regresa el valor
